 ...
 const weight = useMemo(() => {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white">
      <section className="grid min-h-[82vh] grid-cols-2 items-center gap-12 px-16">
        <div>
          ...
          <p className="mt-6 max-w-[700px] text-[20px] leading-8 text-white/75">
          ...
          <div className="mt-8 grid max-w-[650px] grid-cols-3 gap-4">
...
>
  Swastik Silver
          ...
          <input
            ...
            className="mt-3 w-full rounded-2xl border border-white/20 bg-black/40 px-5 py-4 text-[24px] outline-none"
          />
...
weight saved in wallet
      ...
      <section className="bg-[#fbf7ef] px-12 py-20 text-black">
        <div className="mx-auto max-w-[1450px]">
          <div className="text-center">
            ...
            <h2 className="mt-3 font-serif text-[48px]">
              How Quick Buy Works
            </h2>

            <p className="mx-auto mt-4 max-w-[950px] text-[18px] leading-8 text-gray-700">
          ...
          <section className="mt-16 rounded-[34px] bg-white p-10 shadow-xl">
            <h3 className="font-serif text-[40px]">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8">
              ...
              <div className="rounded-[28px] bg-[#fbf7ef] p-8">
          ...
          <section className="mt-16 rounded-[34px] bg-[#111] p-10 text-white shadow-xl">
            <h3 className="font-serif text-[40px]">
              Redeem Options
            </h3>
            ...
            <div className="mt-8 overflow-hidden rounded-2xl border border-[#ead7ae]">
              <table className="w-full border-collapse text-center">
                <thead className="bg-[#5d1f32] text-white">
                  <tr>
                    <th className="p-5">Purchase</th>
                    <th className="p-5">Amount</th>
                    <th className="p-5">Rate / gm</th>
                    <th className="p-5">Metal Saved</th>
                    <th className="p-5">Wallet Status</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  ...
                  <tr className="bg-[#fff3cf] font-bold">
                    ...
                    <td className="p-5">₹8,000</td>
                    <td className="p-5">-</td>
                    <td className="p-5">0.772 gm</td>
          ...
          <section className="mt-16 rounded-[34px] bg-[#fbf7ef] p-10 shadow-xl">
