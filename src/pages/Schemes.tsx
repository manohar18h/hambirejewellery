  ...
  const schemes = [
    {
      ...
      points: ["No wastage benefits", "Old gold exchange", "Priority booking"],
    },
    {
      ...
      points: ["11 month savings", "VA benefits", "Gold rate protection"],
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white">
      <section className="relative flex min-h-screen items-center overflow-hidden px-8">
        ...
        <div className="relative z-10 mx-auto grid max-w-[1500px] grid-cols-2 items-center gap-12">
          <div>
            <p className="mb-4 text-[16px] font-semibold uppercase tracking-[5px] text-[#f5c542]">
              Hambire Jewellery Schemes
            </p>

            <h1 className="font-serif text-[74px] leading-[1.05]">
              Build Wealth. <br />
              Buy Jewellery. <br />
              Save More.
            </h1>

            <p className="mt-6 max-w-[650px] text-[20px] leading-8 text-white/75">
    ...
    View Dashboard
          ...
          <div className="rounded-[40px] border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur-xl">
            <div className="rounded-[32px] bg-gradient-to-br from-[#f8d46a] via-[#b9851c] to-[#3b2105] p-[1px]">
              <div className="rounded-[32px] bg-black/80 p-10">
                <Coins className="mb-8 h-20 w-20 text-[#f5c542]" />
                <h2 className="font-serif text-[42px]">Premium Gold Plans</h2>
      ...
      <section id="scheme-cards" className="bg-[#fbf7ef] px-8 py-24 text-black">
        <div className="mx-auto max-w-[1500px]">
          <div className="mb-14 text-center">
            <p className="text-[15px] font-bold uppercase tracking-[4px] text-[#b98213]">
              Choose Your Plan
            </p>
            <h2 className="mt-3 font-serif text-[52px]">
...
className={`${clickable} group rounded-[34px] border border-[#ead7ae] bg-white p-8 shadow-xl`}              >
                ...
                <h3 className="font-serif text-[32px] leading-tight">
                  {scheme.title}
                </h3>
...
className={`${clickable} mt-9 flex w-full items-center justify-center gap-3 rounded-full bg-black px-6 py-4 text-[16px] font-bold text-white group-hover:bg-[#b98213]`}                >
          ...
          <div className="mt-20 grid grid-cols-4 gap-6">
            {[
              ...
              <div
                key={label}
                className="rounded-[28px] bg-[#111] px-8 py-9 text-center text-white"
              >
